...
namespace Domain::Session
{
  ...
  struct CareerSpecialistSession : SessionBase{ CareerSpecialistSession( const UserCredentials & credentials ); };
  struct JobSeekerSession        : SessionBase{ JobSeekerSession       ( const UserCredentials & credentials ); };
  struct RecruiterSession        : SessionBase{ RecruiterSession       ( const UserCredentials & credentials ); };
  struct ITSession               : SessionBase{ ITSession              ( const UserCredentials & credentials ); };
